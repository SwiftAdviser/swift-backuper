...
DB_BACKUP="/var/backups/mysql"        #Указать каталог для баз
...
FILES_BACKUP="/var/backups/servers"   # абсолютный путь, куда бекапить файлы. Лучше - в папке с этим же бекапером
FILES_PATH="/home/minecraft/servers"  # абсолютный путь, ЧТО бекапить

FTPSERVER=""                          # сервер для бекапа
FTPUSER=""                            # логин для бекапа
FTPPASS=""                            # пароль
FTPLOCALPATH="/var/backups"           # путь, ИЗ которого будем качать файлы на удаленный фтп
